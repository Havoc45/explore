...
| `--reconcile` | Refresh `docs/system-design-reference/` and verify/relink `plans/` against `HEAD`, + skill-usage glossary refresh (`references/closing-the-loop.md`) | both · `references/system-design-reference.md`, `references/closing-the-loop.md` |
