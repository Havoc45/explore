...
Render the whole setup as response text: host, mode, lanes with billing, the roster table, provenance, and the config path that will be written. Then ask **save / redo a step / discard**.
