...
│   │   ├── delegation.md          (2.7.0 org chart mechanics, spiral detection, escalation ladder, steering; 2.8.0 model roster & routing — provider-CLI lanes; 2.9.0 dispatch transports MCP+shell, minion platforms/nesting; 2.10.0 model labeling, codex quirks, computer-use lane, gpt-5.5 workflow wrapper, big-queue parallelism)
